...
export default class Login extends React.Component<Props, State> {
    ...
    register_request = (e: SyntheticEvent<HTMLButtonElement>) => {
        e.preventDefault();
        let {reg_username, reg_password, reg_password_confirm} = this.state;
    ...
    render_tabs() {
        return (
            <ul className="uk-subnav" uk-switcher="connect: .login-content"
                    ...
                    <form onSubmit={function() { return false }}>
                        ...
                        <div className="uk-margin">
                            <button
                                ...
                                type="submit"
                                onClick={this.login_request}>{"Login"}
                            </button>
                        </div>
                    </form>
                </li>
                    ...
                    <form onSubmit={function() { return false }}>
                        ...
                        <div className="uk-margin">
                            <button
                                className="uk-button uk-button-default"
                                type="submit"
                                onClick={this.register_request}>{"Register Now"}
                            </button>
                        </div>
                    </form>
                </li>
